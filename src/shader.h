...
SYCL_EXTERNAL void asl_shade(int id, float Px, float Py, float Pz, float Ix, float Iy, float Iz, float Nx, float Ny, float Nz, float Ngx, float Ngy, float Ngz, float u, float v, float& Cr, float& Cg, float& Cb);
